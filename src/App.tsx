    ...
    <div className="App">
      <Router primary={false}>
        <Guest path={LayoutPaths.Guest}>
          ...
          <PublicRoute path={Paths.EditBibGroup()} component={Pages.EditBibGroup} />
          ...
          <PublicRoute path={Paths.TournamentPaymentSuccess()} component={Pages.TournamentPaymentSuccess} />
          <ProtectedRoute
