...
const TournamentRegisterGroupConfirm: React.FC = () => {
  ...
  const getGroupLoading = useSelector((state: any) => state.loadingReducer[EGetGroupByIdAction.GET_GROUP_BY_ID]);
          ...
          <div className="container">
            <div className="TournamentRegisterPage-wrapper">
              {!error ? (
                ...
                <div className="TournamentRegisterPage-main-success small fail">
                  <div className="TournamentRegisterPage-main-success-header">
                  ...
                  <div className="TournamentRegisterPage-main-success-body">
                    ...
                    <div
                      className="TournamentPaymentPage-main-success-body-btn flex justify-center"
                      style={{ marginTop: 16 }}
                    >
                      <Button
                        size="large"
